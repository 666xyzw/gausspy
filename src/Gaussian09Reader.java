...
class Gaussian09Reader implements MoleculeReader {
  BufferedReader input;
  
  public Gaussian09Reader(Reader paramReader) { this.input = new BufferedReader(paramReader); }
  ...
  void readFrequencies(Molecule paramMolecule) throws Exception {
    ...
    for (String str = this.input.readLine(); str.startsWith(" Frequencies --"); str = this.input.readLine()) {
      ...
      for (str = this.input.readLine(); !str.startsWith("  Atom  AN"); str = this.input.readLine());
      byte b;
...
/* Location:              /home/xyz666/gausspy/Xvibs/xvibs.jar!/Gaussian09Reader.class
