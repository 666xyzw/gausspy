...
class Gaussian94Reader implements MoleculeReader {
  ...
  public Gaussian94Reader(Reader paramReader) { this.input = new BufferedReader(paramReader); }
  ...
  public void read(Molecule paramMolecule) throws Exception {
    while (this.input.ready()) {
      ...
      if (str.indexOf("Standard orientation:") >= 0 || str.indexOf("Z-Matrix orientation:") >= 0) {
